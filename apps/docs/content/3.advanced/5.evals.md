...
Evals help you verify that your MCP tools are called correctly by an LLM. This guide shows how to run tool-call evaluations with [Evalite](https://www.evalite.dev/) using the AI SDK MCP client. The approach stays library-agnostic—Evalite is just the example runner.
